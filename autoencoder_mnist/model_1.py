...
def inference(model_input, keep_prob, train_phase):
    ...
    # encoder
    en_1 = fc_blk(model_input, 512, train_phase, name='en_1')
    en_2 = fc_blk(en_1, 128, train_phase, name='en_2')
    # en_3 = fc_blk(en_2, 256, train_phase, name='en_3')      
    en_4 = fc_blk(en_2, 16, train_phase, name='en_4')
    
    # decoder
    #de_1 = fc_blk(en_4, 256, train_phase, name='de_1') 
    de_2 = fc_blk(en_4, 128, train_phase, name='de_2')
    de_3 = fc_blk(de_2, 512, train_phase, name='de_3')
            
    de_4 = tf.layers.dense(de_3, 784,activation=None)
